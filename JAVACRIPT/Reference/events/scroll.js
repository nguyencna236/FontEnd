...
// 2. debounce: là kỹ thuật buộc một hàm phải đợi một khoảng thời gian nhất định trước khi thực thi.
...
// 5. scrollWidth vs offsetWidth : tương tự như height
// boxed.offsetWidth -> 200 // chỉ lấy độ rộng của element đang xét
// boxed.scrollWidth -> 200 // lấy luông độ rộng của thằng con nếu nó lớn hơn cha

// 6. scrollIntoView(): scroll tới phạm vi mà có thể thấy nó
 boxed.scrollIntoView() //chạy tới vị trí thấy được box